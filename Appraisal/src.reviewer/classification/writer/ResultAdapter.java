...
public class ResultAdapter extends TestCase 
{
	public void test() throws Exception
	{
		...
		adapt(newFile,oldFile);
	}
	public void adapt(File newFile,File oldFile) throws Exception
	{
		// Cria os Workbooks
	...
	private void transpondDeviations(WritableSheet newResultsSheet, Sheet oldDeviationSheet) throws Exception 
	{
		...
		{
			copyColumn(newResultsSheet, oldDeviationSheet, i);
